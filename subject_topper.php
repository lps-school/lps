                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="text-justify">
                            ...
                            <!--<iframe src="http://lpsashokvihar.com/lps-admin/assets/uploads/results/subject_topper.pdf"
                                    style="width:718px; height:600px;" frameborder="0" type='application/pdf'></iframe>-->
                            <?php $sql = "SELECT page_content FROM content WHERE page_name = 'subject_topper'";
