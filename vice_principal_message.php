    ...
    <div class="row">
        <div class="col-md-12">
            <h1><?php if ('chairman_message' == $page) {
                ...
                } elseif ('vice_principal_message' == $page) {
                    echo "Vice Principal Message";
                }
                ?></h1>
            <ul class="breadcrumb">
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    ...
                    <li><a href="vice_principal_message.php" <?php if ('vice_principal_message' == $page) {
                            echo "id=\"active\"";
                        } ?>>Vice Principal Message</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="box-style-one borders"><img src="img/icon-user-default.png" alt=""
                                                                    class="picture img-responsive"><h5>Mrs. Neena Singh</h5>
                            </div>
                        </div>
