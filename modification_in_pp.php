...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>
                <?php if ('date_sheet' == $page) {
                    echo "Date Sheet";
                } elseif ('modification_in_pp' == $page) {
                    echo "Modification in Performance Profile";
                } elseif ('examination_material' == $page) {
                    echo "Examination Material";
                }
                ?></h1>
            <ul class="breadcrumb">
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    <li><a href="date_sheet.php"<?php if ('date_sheet' == $page) {
                            echo "id=\"active\"";
                        } ?>>Date Sheet</a></li>
                    <!--<li><a href="modification_in_pp.php" <?php /*if ('modification_in_pp' == $page) {
                            echo "id=\"active\"";
                        } */?>>Modification in Performance Profile</a></li>-->
                    <li><a href="examination_material.php" <?php if ('examination_material' == $page) {
                            echo "id=\"active\"";
                        } ?>>Examination Material</a></li>
                </ul>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="text-justify">
                            <h4>Modification in Performance Profile :-</h4>
                            <?php $sql = "SELECT page_content FROM content WHERE page_name = 'modification_in_pp'";
