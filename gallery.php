...
$result = $db_handle->runQuery("SELECT * FROM gallery  WHERE  status = 'Active' ORDER BY gallery_id  DESC");
    ...
    <div class="row">
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <p>Gallery of Annual Function,Library,Infrastructure,Events and Lab etc.</p>
            ...
            <div class="col-right">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 picture">
                        <a href="http://lpsashokvihar.com/lps-admin/assets/uploads/gallery/<?php echo $row->gallery_image; ?>" title="<?php echo $row->gallery_title; ?>" class="fancybox" rel="gallery1">
                            <span class="photo_icon"></span>
                            <img src="http://lpsashokvihar.com/lps-admin/assets/uploads/gallery/<?php echo $row->gallery_image; ?>" alt="" class="img-responsive">
                        </a>
                    </div>
