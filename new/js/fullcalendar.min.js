...
(function (t) {
    ...
    function s(n, r) {
        ...
        function p(e) {
            ye++, ce && (Q("viewDestroy", ce, ce, ce.element), Y(), ce.triggerEventDestroy(), $(), ce.element.remove(), oe.deactivateButton(ce.name)), oe.activateButton(e), ce = new _e[e](t("<div class='fc-view fc-view-" + e + "' />").appendTo(se), te), g(), V(), ye--
        }
        ...
        function m(t) {
            ye++, ce.start && (Q("viewDestroy", ce, ce, ce.element), Y(), x()), $(), t && (fe = ce.incrementDate(fe, t)), ce.render(fe.clone()), D(), V(), (ce.afterRender || k)(), H(), F(), Q("viewRender", ce, ce, ce.element), ye--, M()
        }
    ...
    function c(e) {
        ...
        function o(n, r) {
            ...
            if (l)t.isFunction(l) ? (y(), l.call(C, E.clone(), S.clone(), e.timezone, function (t) {
                ...
                if (c) {
                    ...
                    var h = t.extend({}, d || {}), p = A(n.startParam, e.startParam), g = A(n.endParam, e.endParam), m = A(n.timezoneParam, e.timezoneParam);
        ...
        var E, S, k = C.trigger, x = C.getView, M = C.reportEvents, z = C.getEventEnd, R = {events: []}, _ = [R], H = 0, F = 0, N = 0, O = [];
    ...
    function J(e, n, r) {
        ...
        function s() {
            var n = l();
            Y && Y.remove(), Y = t(n).appendTo(e), A = Y.find("thead"), O = A.find(".fc-day-header"), W = Y.find("tbody"), L = W.find("tr"), Z = W.find(".fc-day"), B = L.find("td:first-child"), P = L.eq(0).find(".fc-day > div"), j = L.eq(0).find(".fc-day-content > div"), F(A.add(A.find("tr"))), F(L), L.eq(0).addClass("fc-first"), L.filter(":last").addClass("fc-last"), Z.each(function (e, n) {
        ...
        function c() {
            ...
            for (r += "<thead><tr>", oe && (r += "<th class='fc-week-number " + n + "'>" + R(ie("weekNumberTitle")) + "</th>"), t = 0; G > t; t++)e = ue(0, t), r += "<th class='fc-day-header fc-" + Ne[e.day()] + " " + n + "'>" + R(he(e, ae)) + "</th>";
            return r += "</tr></thead>"
        }
        ...
        function u(t) {
            var e = N.intervalStart.month(), r = n.getNow().stripTime(), a = "", o = re + "-widget-content", i = ["fc-day", "fc-" + Ne[t.day()], o];
        ...
        function v(t) {
            q = t, ee.clear(), ne.clear(), X = 0, oe && (X = A.find("th.fc-week-number").outerWidth()), V = Math.floor((q - X) / G), g(O.slice(0, -1), V)
        }
        ...
        var N = this;
        N.renderBasic = a, N.setHeight = f, N.setWidth = v, N.renderDayOverlay = m, N.defaultSelectionEnd = b, N.renderSelection = D, N.clearSelection = w, N.reportDayClick = C, N.dragStart = E, N.dragStop = S, N.getHoverListener = function () {
            return te
        }, N.colLeft = k, N.colRight = x, N.colContentLeft = M, N.colContentRight = z, N.getIsCellAllDay = function () {
            return !0
        }, N.allDayRow = _, N.getRowCnt = function () {
            return U
            ...
            return I
        }, ge.call(N, e, n, r), Te.call(N), we.call(N), K.call(N);
        var Y, A, O, W, L, Z, B, P, j, I, q, $, V, X, U, G, Q, J, te, ee, ne, re, ae, oe, ie = N.opt, se = N.trigger, le = N.renderOverlay, ce = N.clearOverlays, de = N.daySelectionMousedown, ue = N.cellToDate, fe = N.dateToCell, ve = N.rangeToSegments, he = n.formatDate, pe = n.calculateWeekNumber;
    ...
    function ae(n, r, a) {
        ...
        function i() {
            Fe = Le("theme") ? "ui" : "fc", Ye = Le("isRTL"), We = Le("columnFormat"), Ae = e.duration(Le("minTime")), Oe = e.duration(Le("maxTime")), me = e.duration(Le("slotDuration")), be = Le("snapDuration"), be = be ? e.duration(be) : me
        }
        ...
        function d() {
            ...
            for (a += "<thead><tr>", Le("weekNumbers") ? (t = Ve(0, 0), e = Qe(t), Ye ? e += Le("weekNumberTitle") : e = Le("weekNumberTitle") + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + R(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; xe > n; n++)t = Ve(0, n), a += "<th class='fc-" + Ne[t.day()] + " fc-col" + n + " " + r + "'>" + R(Ge(t, We)) + "</th>";
        ...
        function u() {
            ...
            for (c += "<tbody><tr><th class='fc-agenda-axis " + i + "'>&nbsp;</th>", n = "", e = 0; xe > e; e++)t = Ve(0, e), o = ["fc-col" + e, "fc-" + Ne[t.day()], s], t.isSame(l, "day") ? o.push(Fe + "-state-highlight", "fc-today") : l > t ? o.push("fc-past") : o.push("fc-future"), a = "<td class='" + o.join(" ") + "'>" + "<div>" + "<div class='fc-day-content'>" + "<div style='position:relative'>&nbsp;</div>" + "</div>" + "</div>" + "</td>", n += a;
        ...
        function D(t) {
            if (!Le("selectable")) {
                ...
                if (a) {
                    ...
                    n.add(Ae + o * me), n = r.rezoneDate(n), Ze("dayClick", G[e], n, t)
        ...
        function A(t) {
            ...
            var e = (t - Ae) / me, n = Math.floor(e), r = e - n, a = Je[n];
        ...
        var q = this;
        q.renderAgenda = o, q.setWidth = v, q.setHeight = f, q.afterRender = p, q.computeDateTop = Y, q.getIsCellAllDay = _, q.allDayRow = function () {
            return ae
    ...
    function oe() {
        ...
        function s(t, e) {
            var n = "<", r = t.url, a = N(t, v), o = ["fc-event", "fc-event-vert"];
        ...
        function c(t, n, r) {
            ...
            var o, i, s, l = r.isStart, c = !0, d = S(), u = F(), f = X(), p = W(), g = O(), y = A(), b = Y();
            n.draggable({
        ...
        function d(t, e, n) {
            ...
            var o, i, s, l, c, d, u, p, g, m, y, b, D, w = f.getCoordinateGrid(), T = H(), C = F(), E = Y(), S = A();
            e.draggable({
                scroll: !1,
                grid: [C, E],
                axis: 1 == T ? "y" : !1,
    ...
    function ge(n, r, a) {
        ...
        function u(t, e) {
            Y.push({event: t, element: e}), N[t._id] ? N[t._id].push(e) : N[t._id] = [e]
        }
        ...
        var F = r.reportEventChange, N = {}, Y = [], O = r.options, W = e.duration(O.nextDayThreshold);
    ...
    function me() {
        ...
        function D(t, e) {
            ...
            e.draggable({
                ...
                stop: function (o, i) {
                    a.stop(), $(), E("eventDragStop", e[0], t, o, i), n ? Y(e[0], t, r, o, i) : (e.css("filter", ""), _(t, e))
                }
            })
        }
        ...
        function w(e, r, a) {
            ...
            H(r), r.mousedown(function (t) {
                ...
                function s(n) {
                    E("eventResizeStop", r[0], e, n, {}), t("body").css("cursor", ""), f.stop(), $(), c && A(r[0], e, d, n, {}), setTimeout(function () {
                        l = !1
                    }, 0)
                }
        ...
        var C = T.opt, E = T.trigger, S = T.isEventDraggable, k = T.isEventResizable, x = T.reportEventElement, z = T.eventElementHandlers, _ = T.showEvents, F = T.hideEvents, Y = T.eventDrop, A = T.eventResize, O = T.getRowCnt, W = T.getColCnt, L = T.allDayRow, Z = T.colLeft, B = T.colRight, P = T.colContentLeft, j = T.colContentRight, I = T.getDaySegmentContainer, q = T.renderDayOverlay, $ = T.clearOverlays, V = T.clearSelection, X = T.getHoverListener, U = T.rangeToSegments, G = T.cellToDate, Q = T.cellToCellOffset, J = T.cellOffsetToDayOffset, K = T.dateToDayOffset, te = T.dayOffsetToCellOffset, ee = T.calendar, ne = ee.getEventEnd
    }
    ...
    }, Re = t.fullCalendar = {version: "2.0.1"}, _e = Re.views = {};
    ...
    Re.applyAll = Y;
    var Ne = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Ye = /^\s*\d{4}-\d\d$/, Ae = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/;
    Re.moment = function () {
        return O(arguments)
