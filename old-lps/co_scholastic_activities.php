        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    ...
                    <li><a href="social_service_projects.php" <?php if ('syllabus' == $page) {
                            echo "id=\"active\"";
                    ...
                    <li><a href="news-events" <?php if ('news-events' == $page) {
                            echo "id=\"active\"";
                        } ?>>News & Events</a></li>
                </ul>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="text-justify">
                            <h4>Co Scholastic Activities</h4>
                            <?php $sql = "SELECT page_content FROM content WHERE page_name = 'co_scholastic_activities'";
