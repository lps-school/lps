    ...
    <div class="row">
        <div class="col-md-12">
            <h1><?php if ('academics' == $page) {
                    ...
                    echo "Transport";
                } elseif ('admission' == $page) {
                    echo "Admission";
                }
                ?></h1>
            <ul class="breadcrumb">
                <li><a href="index.php">Home</a> <span class="divider">/</span></li>
                <li class="active"><?php if ('academics' == $page) {
                        echo "Academics";
                    } elseif ('library' == $page) {
                        echo "Library";
                    } elseif ('knowledge_center' == $page) {
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    <li><a href="academics.php"<?php if ('academics' == $page) {
                            echo "id=\"active\"";
                        } ?>>Academics</a></li>
                    <li><a href="library.php" <?php if ('circulars' == $page) {
                            echo "id=\"active\"";
                        } ?>>Library</a></li>
                    <li><a href="knowledge_center.php" <?php if ('academic_calendar' == $page) {
                            echo "id=\"active\"";
                        } ?>>Knowledge Center</a></li>
                    <li><a href="medical_facility.php" <?php if ('syllabus' == $page) {
                            echo "id=\"active\"";
                        } ?>>Medical Facility</a></li>
                    <li><a href="transport.php" <?php if ('media_coverage' == $page) {
                            echo "id=\"active\"";
                        } ?>>Transport</a></li>
                </ul>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="text-justify">
                            <h4>Academics</h4>
                            <ul class="list_1">
                                <li>Lions Public School is a co-educational school from Nursery to XII. It prepares the
                                    students for the senior school (XII) and the secondary school (X) certificate of the
                                    Central Board of Secondary Education (C.B.S.E). The medium of instruction is
                                    "English".
                                </li>
                            </ul>
                        </div>
