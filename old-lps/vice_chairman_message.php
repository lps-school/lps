...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1><?php if ('chairman_message' == $page) {
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><?php if ('chairman_message' == $page) {
                        echo "Chairman Message";
                    } elseif ('vice_chairman_message' == $page) {
                        echo "Vice Chairman Message";
                    } elseif ('principal_message' == $page) {
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    <li><a href="chairman_message.php"<?php if ('chairman_message' == $page) {
                            echo "id=\"active\"";
                        } ?>>Chairman Message</a></li>
                    <li><a href="vice_chairman_message.php" <?php if ('vice_chairman_message' == $page) {
                            echo "id=\"active\"";
                        } ?> >Vice Chairman Message</a></li>
                    <li><a href="principal_message.php" <?php if ('principal_message' == $page) {
                            echo "id=\"active\"";
                        } ?>>Principal Message</a></li>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-12">
                            ...
                            <p>" It is a matter of pride and gratitude that the Lions Public School, at Ashok Vihar is
                                imparting best education to the needy people at very low cost but simultaneously not
                                compromising at all with the standard and quality of education which is at part with the
                                other reputed Public Schools.</p>

                            <p>I appreciate that the school has been upgraded up to senior secondary standard with all
                                full fledged computer, mathematical laboratories and library with its wide range of
                                books. "</p>
                        </div>
                    </div>
                </div>
