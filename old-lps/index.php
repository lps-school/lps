        ...
        <aside class="col-md-4 col-sm-4">
            ...
            <div class="box-style-1 ribbon borders">
                ...
                <div class="feat">
                    ...
                    <p>Mon to Sat 8:30 AM to 2:20 PM <br>
                        Last Working Day 11:10 AM
                    </p>
                </div>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php $sql = "SELECT page_content FROM content WHERE page_name = 'principal_message'";
                            $result_index = $db_handle->runObjectQuery($sql);
                            ...
                            ?>
                            <ul class="data-lessons">
                                <li><i class="icon-arrow-right"></i><a href="principal_message.php">Read More</a></li>
