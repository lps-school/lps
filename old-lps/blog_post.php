...
<div class="container">
    ...
    <div class="row">
            ...
            <div class="col-left">
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <p>
                            Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem.
        ...
        <section class="col-md-8 col-sm-8">
            <div class="col-right">
                <div class="post">
                    <h2><a href="blog_post.php">Duis aute irure dolor in reprehenderit</a></h2>
                    ...
                    <p>
                        ...
                        suscipit varius mi nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc
                    ...
                    <p><a href="blog_post.php" class="button_medium">Read more</a></p>
                </div>
                <!-- end post -->
                <hr>
                ...
                <div id="comments">
                    <ol>
                        ...
                        <li>
                            <div class="avatar"><a href="#"><img src="img/avatar1.jpg" alt=""
                                                                 class="img-responsive"></a></div>
                            <div class="comment_right clearfix">
                                <div class="comment_info">Posted by <a href="#">Anna Smith</a><span>|</span> 25 apr 2019
                                    <span>|</span><a href="#">Reply</a></div>
                                <p>
                            ...
                            <ul>
                                <li>
                                    <div class="avatar"><a href="#"><img src="img/avatar2.jpg" alt=""
                                                                         class="img-responsive"></a></div>
                                    <div class="comment_right clearfix">
                                        <div class="comment_info">Posted by <a href="#">Tom Sawyer</a><span>|</span> 25
                                            apr 2019 <span>|</span><a href="#">Reply</a></div>
                                        <p>
                        ...
                        <li>
                            <div class="avatar"><a href="#"><img src="img/avatar3.jpg" alt=""
                                                                 class="img-responsive"></a></div>
                            <div class="comment_right clearfix">
                                <div class="comment_info">Posted by <a href="#">Adam White</a><span>|</span> 25 apr 2019
                                    <span>|</span><a href="#">Reply</a></div>
                ...
                <form action="#" method="post">
                    ...
                    <input class="form-control" type="text" name="mail" value="Email"
