    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><?php if ('notice_board' == $page) {
                        echo "Notice Board";
                    } elseif ('library' == $page) {
                        echo "Library";
                    } elseif ('knowledge_center' == $page) {
        ...
        <aside class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    <li><a href="computer_lab.php"<?php if ('notice_board' == $page) {
                            echo "id=\"active\"";
                        } ?>>Notice Board</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="text-justify">
                            <h4>Notice Board</h4>
                                ...
                                <?php
                                $sql = "SELECT notice FROM noticeboard WHERE id = '$id'";
                                $result = $db_handle->runObjectQuery($sql);

                                //print_r($result);
                              echo $result[0]->notice;
