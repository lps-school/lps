                ...
                <div class="strip-lessons">
                    <div class="row">
                        ...
                        <div class="text-justify">
                            <h4>Overall Result Class 12</h4>
                            <!--<iframe src="http://lpsashokvihar.com/lps-admin/assets/uploads/results/result_class_12_.pdf"
                                    style="width:718px; height:600px;" frameborder="0" type='application/pdf'></iframe>-->
                            <?php $sql = "SELECT page_content FROM content WHERE page_name = 'result_class_12'";
